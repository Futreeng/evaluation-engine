...
(function () {
  ...
  const PRICING = {
    ...
    tiers: [
      ...
      { tier: 'growth_plan', name: 'Growth', description: 'Your full plan, posts written for you every week, and a score that moves.', monthlyPrice: 19, annualPrice: 190, popular: true, features: ['Your full plan: every move, plus the 12-week posting calendar', 'Posts written for you every week — 6, with hooks, captions and scripts', 'See your score move every week — history and change emails', '48-hour reviews of every new post', 'The Monday move', 'Levels, streaks with freezes, personal records and milestone cards', "What's working in your niche, weekly", 'Competitor comparison, up to 5 handles', 'One platform'], cta: 'Start Growth', limits: LIM.growth_plan },
      { tier: 'growth_plan_pro', name: 'Pro', description: 'Every platform you’re on, rescored every 3 days, with double the writing.', monthlyPrice: 39, annualPrice: 390, features: ['Everything in Growth', 'All supported platforms scored under one plan', 'Rescores every 3 days instead of weekly', '12 written posts per week', 'Competitor comparison, up to 10 handles', 'Higher fair-use limits'], cta: 'Start Pro', limits: LIM.growth_plan_pro }
    ],
    business: [
      { tier: 'business_growth', name: 'Business Growth Plan', description: 'Scored against your category; the plan is written for bookings.', monthlyPrice: 39, annualPrice: 390, features: ['Everything in Growth', 'Category benchmarks for businesses', 'Moves written for bookings, not followers'], cta: 'Start Business Growth Plan' },
