  ...
  async function viewReport(reportId) {
    ...
    $view.innerHTML = h`
      <div class="wrap">
        ...
        ${paid && !isSample && (report.post_reviews || []).length ? raw(h`<details class="card reviews"><summary>Your posts, 48 hours in <span class="fine">${report.post_reviews.length} reviewed</span></summary>
