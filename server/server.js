...
<div class="fine">Scores read public data only. <a href="${base}/#/how" style="color:#5B4C3B;text-decoration:underline">How the score works</a></div></main></body></html>`);
