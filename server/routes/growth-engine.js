...
<a href="${app}/#/reports" style="display:inline-block;margin-top:8px;padding:12px 18px;border-radius:12px;background:#B84E2A;color:#FFF6E9;text-decoration:none;font-weight:700">Your reports</a></main>`);
});
...
<a href="${app}/" style="display:inline-block;margin-top:8px;padding:12px 18px;border-radius:12px;background:#B84E2A;color:#FFF6E9;text-decoration:none;font-weight:700">Scalecraft</a></main>`);
});
